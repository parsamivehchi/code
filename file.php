...
<html>
    <head>
        ...
        <link href="https://parsa1.com/css/file-manager.css" media="screen" rel="stylesheet" type="text/css" />
    </head>
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="https://parsamivehchi.com"><img src="https://parsa1.com/img/logo.png" alt="Web hosting" height="128px" width="128px"/></a>
                </div>
                <div class="content">
                    <h1>Parsa Mivehchi</h1>
            ...
            <div id="footer">
                <div class="links">
                    <a href="https://parsamivehchi.com" target="_blank">Parsa Mivehchi</a> 
                </div>
                <div class="copyright">Parsa Mivehchi  &copy; <? print date('Y'); ?>. All rights reserved</div>
                <? echo '<time datetime="'.date('c').'">'.date('d, D / M / Y').'</time>'; ?>
            </div>
        </div>
    </body>
</html>
